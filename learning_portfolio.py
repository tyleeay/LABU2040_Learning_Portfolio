...
def show_presentation_two():
    ...
    with st.expander("Applied Learning & Development", expanded=True):
        ...
        <div class="reflection-text">
        <strong>Professor's Feedback & Evidence of Growth:</strong>

        1. **Task Completion & Content Delivery (Very Good):**
           - Successfully identified main problems while maintaining a constructive tone
           - Effectively used real-life examples to support policy change recommendations
           - Developed logical and sensible recommendations
           - Achieved excellent time management with clear, concise messaging
           - Area for development: Could enhance explanations from Chairman's perspective

        2. **Organization & Teamwork (Competent):**
           - Maintained appropriate formality and politeness in introduction
           - Contributed to smooth transitions between team members
           - Demonstrated even time distribution (approximately 3 minutes each)
           - Area for development: Could strengthen establishment of consultant credibility and details reponses on Q&A

        3. **Delivery Improvements (Very Good):**
           - Demonstrated confident and composed presence
           - Enhanced hand gestures with better variety and connection to key points
           - Improved facial expressions showing positive energy and enthusiasm
           - Maintained strong and consistent eye contact
           - Area for development: Reduce side-to-side movement

        4. **Language Enhancement (Competent):**
           - Achieved more natural overall tone compared to Case 1
           - Demonstrated stronger vocal projection with effective keyword emphasis
           - Added greater vocal variety and intonation changes
           - Maintained accurate grammar and pronunciation
           - Area for development: Continue practicing flow / Fluency to reduce hesitations
        </div>

        <div class="learning-strategy">
        <strong>Ongoing Development Focus:</strong>

        Moving forward, I am committed to continuous improvement in my presentation skills. The valuable feedback from this presentation has highlighted key areas where I can further develop: deepening my consideration of audience perspectives when crafting recommendations, establishing stronger consultant credibility in my introductions, refining my physical presence and movement control, providing more detailed responses during Q&A sessions, and enhancing my overall speech fluency. I view these areas not as limitations but as opportunities for growth, and I am excited to continue developing these skills through practice and future presentation opportunities.
        </div>
        """, unsafe_allow_html=True)
